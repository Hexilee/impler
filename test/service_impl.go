...
This file is generated by github.com/Hexilee/impler at 2018-10-15 20:57:48.657933 +0800 CST m=+0.231776721
DON'T EDIT IT!
*/
...
func NewService(scheme, userAgent, ga string) Service {
	service := &serviceImpl{
		cookies: make([]*http.Cookie, 0),
		header:  make(http.Header),
	}
	service.baseUrl = fmt.Sprintf("%s://box.zjuqsc.com/item", scheme)
	service.header.Add("User-Agent", userAgent)
